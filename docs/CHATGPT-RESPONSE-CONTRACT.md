...
Use `personal-ops coordination handoff-test` when Codex needs fixture-backed confidence that baseline, diff, yellow-health, unavailable-source, and deferred-Notion packet shapes still satisfy the contract.
